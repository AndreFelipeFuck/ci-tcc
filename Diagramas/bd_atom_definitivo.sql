...
--
-- Host: localhost
-- Tempo de geração: 05-Out-2019 às 22:05
...
(5, 'Andre', '70d56a828f5cc4429d0bb97cd903ea95.jpg', '2019-10-03', 'Agropecuária', 'andre@gmail.com', '25d55ad283aa400af464c76d713c07ad', 'Segundo');
...
INSERT INTO `comentarios` (`codComentario`, `dataComentario`, `comentario`, `alunos_codAluno`, `professores_codProfessor`, `artigo_codArtigo`) VALUES
(1, '2019-10-02', 'Top', 5, NULL, 25),
(2, '2019-10-09', 'Muito top', 5, NULL, 25),
(5, '2019-10-05', 'a', 5, NULL, 25),
(10, '2019-10-05', 'Po meu trabalho do Adamito', 5, NULL, 25),
(9, '2019-10-05', 'b', 5, NULL, 25),
(11, '2019-10-05', 'bora', 5, NULL, 25);
...
--
ALTER TABLE `alunos`
  MODIFY `codAluno` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de tabela `artigos`
--
ALTER TABLE `artigos`
  MODIFY `codArtigo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
